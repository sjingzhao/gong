...
type UserServiceClient interface {
	...
	AddUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserRequest, error)
}
...
func (c *userServiceClient) AddUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserRequest, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserRequest)
...
type UserServiceServer interface {
	...
	AddUser(context.Context, *User) (*UserRequest, error)
...
func (UnimplementedUserServiceServer) AddUser(context.Context, *User) (*UserRequest, error) {
